...
<jsp:include page="nav.jsp" />
    ...
    <form id="checkInForm" method="post" action="submit_checkout.jsp">
        ...
        <input type="hidden" id="outTime" name="outTime" value="<%= java.time.LocalDateTime.now() %>">

        <!-- Display in-time (readonly) -->
        <label for="outTime">Out Time:</label>
        <input type="text" id="outTimeDisplay" value="<%= java.time.LocalDateTime.now() %>" readonly>
        <br>
